...
function generateCourseDetails(courseName: string, baseDescription: string) {
  const categories = {
    'Trabajo en Alturas': 'Seguridad Integral',
    'Espacios Confinados': 'Seguridad Integral',
    'Control y Extinción de Incendios': 'Emergencias',
    'Primeros Auxilios Básicos y Avanzados': 'Emergencias',
    'Materiales y Mercancías Peligrosas': 'Seguridad Integral',
    'Brigada de Emergencia': 'Emergencias',
    'Planes de Emergencia': 'Emergencias',
    'Seguridad Acuática': 'Seguridad Integral',
    'Seguridad Física': 'Seguridad Integral',
    'Control de Calidad': 'Gestión',
    'Inspecciones Certificadas': 'Seguridad Integral',
    'Reintegro Laboral': 'Gestión',
    'Lockout Tagout': 'Seguridad Integral',
    'Buceo': 'Seguridad Integral',
    'Tareas de Alto Riesgo': 'Seguridad Integral',
    'Operación Segura de Montacargas': 'Seguridad Integral',
    'LOTO - Bloqueo y Etiquetado': 'Seguridad Integral',
    'Brigadas de Emergencia': 'Emergencias',
    'Seguridad en Trabajos en Caliente': 'Seguridad Integral',
    'Sistema de Gestión ISO 9001': 'Gestión',
    'Seguridad en el Izaje de Cargas': 'Seguridad Integral',
    'Buceo Scuba Diver': 'Seguridad Integral',
  ...
  const instructors = {
    'Trabajo en Alturas': 'Ing. Carlos Rodríguez - Especialista en Seguridad Integral',
    ...
    'Tareas de Alto Riesgo': 'Ing. Carlos Rodríguez - Especialista en Seguridad Integral',
  ...
  return {
    ...
    category: (categories as any)[courseName] || 'Seguridad Integral',
    students: students,
