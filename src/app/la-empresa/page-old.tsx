  ...
  return (
    <div className="bg-white">
      ...
      <StandardHero
        ...
        title="La Empresa"
        subtitle="Más de 20 años de experiencia en seguridad integral y control de riesgos empresariales"
        showStats={true}
        stats={[
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base md:text-lg text-slate-600 max-w-2xl mx-auto">
              Conoce más sobre nuestra empresa, experiencia y compromiso con la excelencia en seguridad integral
            </p>
          </motion.div>
