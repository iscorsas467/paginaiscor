        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            ...
            <div className="relative" style={{ pointerEvents: 'auto', zIndex: 10 }}>
              <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 p-8" style={{ pointerEvents: 'auto', zIndex: 10 }}>
                ...
                <div className="relative" style={{ pointerEvents: 'auto', zIndex: 20 }}>
                  ...
                  {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8" style={{ pointerEvents: 'auto', zIndex: 30 }}>
